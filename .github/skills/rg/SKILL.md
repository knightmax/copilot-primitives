---
name: rg
description: "⚡ IMPORTANT: Auto-trigger for text search. Use when: search for text, find files containing, locate TODOs, security scan secrets, trace class usage, grep pattern matching. Returns only matching lines. 30-98% token savings. 3-4x faster than grep/Select-String."
---
