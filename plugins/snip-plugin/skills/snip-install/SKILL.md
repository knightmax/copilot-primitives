---
name: snip-install
description: "Install and configure snip CLI with all output filters (Maven/mvnd, npm, dotnet). Use when setting up snip for the first time, adding filters to a new machine, or after adding a new technology filter."
argument-hint: "Run install script to deploy snip + all filters."
